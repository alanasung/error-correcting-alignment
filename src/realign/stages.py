"""Experiment stages for Active Correction Loops for Alignment Drift."""
...
from .realign._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Active Correction Loops for Alignment Drift", "claims_gated": True})
