...
from realign.configs.loader import register_schema
...
def _load_stage_registry(package: str = "realign") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in realign.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from realign.configs.loader import config_to_dict, save_resolved_config
    from realign.models.device import get_device
    from realign.utils.logging import configure_logging
    from realign.utils.reproducibility import set_seed
    from realign.utils.run_manifest import create_run_dir, save_run_metadata
