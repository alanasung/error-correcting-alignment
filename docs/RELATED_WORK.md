...
This note situates **Active Correction Loops for Alignment Drift** against the mentor-linked literature for
[Active Correction Loops for Alignment Drift](https://github.com/alanasung/error-correcting-alignment).

## Positioning

Pilot an error-correction style loop that detects and repairs alignment drift on toy tasks.

The design hypothesis is: Pilot an error-correction style loop that detects and repairs alignment drift on toy tasks.
